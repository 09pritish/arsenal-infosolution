...
export const SOLUTIONS: Solution[] = [
  ...
  },
  {
    ...
    "keyFeatures": [
      ...
      "Efficient operation",
      "360 degree services for DC components"
    ],
    "businessBenefits": [],
    "techPartners": [
      "Cisco",
  ...
  },
  {
    ...
    "keyFeatures": [
      ...
      "Software Licensing Assessment Services",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Our team of globally recognized certified consultants have an expertise in architecture design and implementation services, and build a roadmap for the smooth migration of your crucial files and data from your on-premise setup to the state-of-the-art cloud productivity platform",
          "Our holistic and innovative strategies cater to your business needs helping you attain maximum gain from existing and emerging business opportunities. As efficient consultants, our focus is to help you enhance your business output and build a roadmap for the exponential growth of your enterprise",
          "We help enterprises create an optimized environment wherein they can store their critical data in the private cloud and the lesser critical data in the public cloud.",
          "Our team of globally recognized certified consultants have an expertise in architecture designing and implementation services using OEM products like AWS, Microsoft, VMware, and Citrix",
          "We provides the state-of-the-art public cloud services which help enterprises take advantage of the centralization and virtualization that cloud computing offers. Our services accelerate the growth of your business with minimum security threat.",
          "Our services include ceaseless surveillance of servers for accessibility and utilization, incident & problem management, OS health management and upgrades, user management services"
        ],
        "lists": [],
        "images": [
          {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Transform not just how you meet, but how you work. We provides the best conferencing tool for the job and the workplace.",
          "We offers a comprehensive portfolio of products, including contact center, calling, meetings, team collaboration, and devices",
          "Improve collaboration with intelligent endpoints designed for every use case. Get the latest technology and increase collaboration adoption with a simple, affordable subscription",
          "Work intuitively. Bring people together anywhere, on any device, with integrated collaboration Get market-leading unified communications delivered on-premises, in the cloud, and any stage in between",
          ...
          "Collaboration creates the possibility of remote collaboration that's simple, reliable and secure. Video conferencing solution designed to communicate, ideate, iterate from anywhere, anytime."
        ],
        "lists": [],
        "images": [
          {
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          "Cyber security is one of the key challenges that is faced by all of us. We help you to build a robust secure framework for addressing all your security concerns with focus on monitoring , reporting and mitigation"
        ],
        "lists": [],
        "images": [
          {
      ...
      },
      {
        ...
        "paragraphs": [
          "End point protection solution comprising anti virus , threat detection and response,device management and data leak protection based on your environment and threat landscape",
          "Providing multi layer security across public , private and hybrid cloud environment through a range of solutions from world leading OEM's based on your threat landscape",
          "Using mix of tools and solutions for identifying threats and vulnerabilities in existing set up and addressing the same using best of bread solutions",
          "End to security architechture framework with log corelation for a better monitoring , management and effective response",
          "Multi level secure authentication , single sign on and identity based access to resources based on industry standards and best practices"
        ],
        "lists": [],
        "images": [
          {
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          "Data center build and integration of multiple solutions related to data center, integration of passive and active components including design , supply and execution"
        ],
        "lists": [],
        "images": [
          {
      ...
      },
      {
        ...
        "paragraphs": [
          "Optimisation of the data center components for more cost effective usage and deployment",
          "Integrated view for ease of management and scalability",
          "Round the clock service for all critical components to be deployed in DC"
        ],
        "lists": [],
        "images": [
          {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Data center build and integration of multiple solutions related to data center",
          "Anytime anywhere any device secure connectivity to all stakeholders in an organisation",
          "HPC Infiniband as well as IP based solutions with complete sizing , design , supply and execution",
          "Network monitoring , management and help desk integration for round the clock support",
          "Turnkey IT management using best in class EMS solution for your requirement"
        ],
        "lists": [],
        "images": [
          {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Our exclusive Resource Management System helps with complete employee lifecycle management, right from their hire to retire"
        ],
        "lists": [],
        "images": [
          {
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          "Planning , designing (Building HLD's and LLD's) , supply , execution and support of your complete network. We provide single window turnkey networking solutions for best performance"
        ],
        "lists": [],
        "images": [
          {
      ...
      },
      {
        ...
        "paragraphs": [
          "Data center network design , SDN enablement , end to end virtualisation and providing a seamless integration with compute resources",
          "End to end LAN & WAN solutions using latest SDN led technology framework for a robust and scalable set up",
          "Fiber to home deployment with a complete ownership of passive as well as active design along with execution",
          "Wireless deployment using best in class heat mapping survey tools, access point mapping as per user density and controlling both on premise as well on cloud",
          "End to end VPN enablement for providing a secure access to employees and other stakeholders to data resources and applications"
        ],
        "lists": [],
        "images": [
          {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "We do complete site survey and suggest a bill of material as per your locations and node requirements along with the exact path layout",
          "UPS requirements for your datacenter as well as for a multi UPS set up is provided based on a power calculation of your devices",
          "Racks as per requirement are suggested with PDU's and other associated components",
          "Chemical earthing is done as per the requirement"
        ],
        "lists": [],
        "images": [
          {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Our CCTV solution design based on requirement , proposing the right set of equipment and execution of the same",
          "Physical access control solution of campuses",
          "Implementing and configuration of the backend analytics tools."
        ],
        "lists": [],
        "images": [
          {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "We do server sizing i.e racks/blades , supply and do execution",
          "We do storage sizing based on greenfield requirement or sizing augmentation of existing storage, supply and execution of the same",
          "End to to end virtualisation of storage and compute",
          "We provide best of breed solutions for back up requirement",
          "OS as per requirement is provided based on requirement"
        ],
        "lists": [],
        "images": [
          {
      ...
      },
      {
        ...
        "paragraphs": [
          "We deploy cloud-like infrastructure on-premises with lower costs, more control, and improved security",
          "We help you choose an as-a-service option from the largest HCI cloud ecosystem for faster speed of deployment and less time spent managing infrastructure",
          "We help manage a mix of VM- and container-based applications, deployed across a mix of data center, public cloud and edge environments"
        ],
        "lists": [],
        "images": [
          {
